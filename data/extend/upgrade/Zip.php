...
class Zip
{
	 ...
	 * @return boolean
	 */
	public function compress($zip_filename='xxx.zip', $dir='./', $path_replace='')
	 {
	 ...
	 * @return boolean
	 */
	public function decompress($zip_filename='xxx.zip', $dir='./')
	{
			$index = array(-1);
			$ok = 0;
...
//下面是zip解压部分
 protected   function ReadFileHeader($zip, $header)
  {
