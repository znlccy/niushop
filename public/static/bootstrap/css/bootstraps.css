...
textarea:focus, input[type="text"]:focus, input[type="password"]:focus,
	...
	border-color: rgba(222, 83, 60, 0.8);
	outline: 0;
...
.dropdown-menu>li>a:hover, .dropdown-menu>li>a:focus, .dropdown-submenu:hover>a,
	...
	background-image: -moz-linear-gradient(top, #de533c, #d3442c);
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#de533c),
		to(#d3442c));
	background-image: -webkit-linear-gradient(top, #de533c, #d3442c);
	background-image: -o-linear-gradient(top, #de533c, #d3442c);
	background-image: linear-gradient(to bottom, #de533c, #d3442c);
	background-repeat: repeat-x;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffde533c',
		endColorstr='#ffd3442c', GradientType=0);
}
...
.dropdown-menu>.active>a, .dropdown-menu>.active>a:hover, .dropdown-menu>.active>a:focus
	...
	text-decoration: none;
	background-color: #0081c2;
	background-image: -moz-linear-gradient(top, #de533c, #d4452e);
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#de533c),
		to(#d4452e));
	background-image: -webkit-linear-gradient(top, #de533c, #d4452e);
	background-image: -o-linear-gradient(top, #de533c, #d4452e);
	background-image: linear-gradient(to bottom, #de533c, #d4452e);
	background-repeat: repeat-x;
	outline: 0;
	filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ffde533c',
		endColorstr='#ffd4452e', GradientType=0);
}
...
.btn-primary {
	...
	*background-color: #0044cc;
	background-image: -moz-linear-gradient(top, #de533c, #0044cc);
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#de533c),
		to(#0044cc));
	background-image: -webkit-linear-gradient(top, #de533c, #0044cc);
	background-image: -o-linear-gradient(top, #de533c, #0044cc);
	background-image: linear-gradient(to bottom, #de533c, #0044cc);
	background-repeat: repeat-x;
...
.btn-info {
	...
	*background-color: #338cd6;
	background-image: -moz-linear-gradient(top, #338cd6, #2983cf);
	background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#338cd6),
		to(#2983cf));
	background-image: -webkit-linear-gradient(top, #338cd6, #2983cf);
	background-image: -o-linear-gradient(top, #338cd6, #2983cf);
	background-image: linear-gradient(to bottom, #338cd6, #2983cf);
	background-repeat: repeat-x;
	border-color: #338cd6 #338cd6 #338cd6;
	border-color: rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.1) rgba(0, 0, 0, 0.25);
...
a.thumbnail:hover, a.thumbnail:focus {
	border-color: #de533c;
	-webkit-box-shadow: 0 1px 4px rgba(222, 83, 60, 0.25);
	-moz-box-shadow: 0 1px 4px rgba(222, 83, 60, 0.25);
	box-shadow: 0 1px 4px rgba(222, 83, 60, 0.25);
}
