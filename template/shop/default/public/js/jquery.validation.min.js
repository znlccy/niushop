...
}, "<i class='icon-exclamation-sign'></i>请输入正确的手机号");
/**
 * 电话号码
 */
jQuery.validator.addMethod("telhone", function(value, element) {
	return this.optional(element) || (/^\d{3,4}-?\d{7,9}$/.test(value));
}, "<i class='icon-exclamation-sign'></i>请正确填写电话号码");
/**
 * 电话号码或者手机
 */
jQuery.validator.addMethod("mphone", function(value, element) {
	var mobile = /^0?(13|15|17|18|14)[0-9]{9}$/;
    var tel = /^\d{3,4}-?\d{7,9}$/;
    return this.optional(element) || (tel.test(value) || mobile.test(value));
}, "<i class='icon-exclamation-sign'></i>请输入正确的联系方式");
/**
 *	bycj [ 验证小数不能超出2位 ]
 *	@example
 * <input class="text price" name="goodsPrice0" data-rule-ncdec="true" data-goods-price0 type="text" data-rule-required="true" data-rule-number="number" data-rule-min="0.01">
 *
 */
jQuery.validator.addMethod("ncdec", function(value, element) {
	return this.optional(element) || /^\d+(\.\d{1,2})?$/.test(value);
}, "<i class='icon-exclamation-sign'></i>小数位不能超过2位");
/**
 *	判断密码可以为空，如果填必须在6-20个字符
 *
 */
jQuery.validator.addMethod("emptyOrPassword", function(value, element) {
    var v = $.trim(value);
    var len = v.length;
    if(!v || len === 0) {
        return true;
    }
	return this.optional(element) || (len >= 6 && len <= 20);
}, "<i class='icon-exclamation-sign'></i>密码为6-20个字符");
